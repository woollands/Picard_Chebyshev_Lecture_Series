...
% File name     : clenshaw_curtis_fvpI.m
% Description   : Generates constant matrices for first order 
%                 Clenshaw & Curtis Quadrature (FINAL VALUE PROBLEM)
...
function [T1,P1,Ta,A] = clenshaw_curtis_fvpI(N,M)
...
U = zeros(N+1,N+1);
for k = 0:N
    U(1,k+1) = cos(k*acos(1)); % Const of Integration (CoI)
end
