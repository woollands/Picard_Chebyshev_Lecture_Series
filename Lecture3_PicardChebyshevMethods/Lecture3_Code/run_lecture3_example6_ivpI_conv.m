...
% File name     : lecture3_example6_ivpI_conv.m
...
%% Picard-Chebyshev Convergence Analysis (Example 6: First Order IVP)
...
% N vs max eigenvalue of [T*P1*A]
figure(3)
loglog(Nvec,maxE,'ks-','Linewidth',2)
grid on
set(gca, 'FontName', 'Helvetica','FontSize',16)
xlabel('N')
ylabel('|\lambda_{max}(TP_1A)|')
